...
# --- Initialize Window ---
root = Tk()
root.title("Suite Rooms Available")
...
def open_customer_details(room_name, rate, image_file, checkin, checkout):
    root.destroy()
    subprocess.run(["python3", "customer_details.py", room_name, rate, image_file, checkin, checkout])

# --- Today's Date ---
today = datetime.today().strftime("%Y-%m-%d")

# ---Title ---
Label(root, text="Suite Rooms Available", font=("Arial", 30, "bold"), fg="teal", bg="white").pack(pady=10)
...
# --- Load Room Image ---
room_img = Image.open("suite_room.png")
room_img = room_img.resize((160, 110))
room_photo = ImageTk.PhotoImage(room_img)

# --- Suite Rooms List ---
rooms = [
    {"name": "Suite Room S301", "price": "₹5,000 / night"},
    {"name": "Suite Room S302", "price": "₹5,000 / night"},
    {"name": "Suite Room S303", "price": "₹5,000 / night"},
    {"name": "Suite Room S304", "price": "₹5,000 / night"},
    {"name": "Suite Room S305", "price": "₹5,000 / night"},
    {"name": "Suite Room S306", "price": "₹5,000 / night"},
    {"name": "Suite Room S307", "price": "₹5,000 / night"},
    {"name": "Suite Room S308", "price": "₹5,000 / night"},
]
...
# --- Create Room Cards with Booking Button ---
def refresh_rooms():
...
# --- Refresh on Launch and Button Press ---
refresh_rooms()
